          ...
          <div className="row g-4 justify-content-between">
            <div className="col-xxl-6 col-xl-7 col-lg-8">
              <div className="achivements-content">
                ...
                For over four decades, DAN General Trading has earned a strong reputation in Kuwait’s
industrial sector. Our consistent commitment to quality, safety, and service excellence has
positioned us as a trusted name across oil, gas, petrochemical, and infrastructure domains.
                </p>
                <div className="row">
